...
import com.example.menyaka.Utils.GlideImageLoader;
...
public class NextScreenActivity extends AppCompatActivity {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(MediaFilesScanner.isVideo(path)){
                    if(checkVideoDuration()) {
                        ...
                        Toast.makeText(mActivity, "The video length should not exceed the 30 seconds!!", Toast.LENGTH_SHORT).show();
                    }
                }else {
                    progressBar.setVisibility(View.VISIBLE);
                    uploadText.setVisibility(View.VISIBLE);
    ...
    private void goBack(){
        ImageView back_view = findViewById(R.id.share_back);
